        ...
        <div className="grid w-full grid-cols-8 gap-4 laptop:gap-16 py-0">
          <div className=" col-span-8 flex flex-col items-start justify-start order-2 py-10 laptop:py-0 laptop:col-span-3 laptop:order-1 sm:col-span-8 sm:py-6 mobile:col-span-8">
            ...
            <p className=" text-dark font-medium dark:text-light ">
              {" "}
              Hello! I&#39;m  Laura from Vietnam, and I have genuine passion about customer support and everything around it. 
              I&#39;m lucky to have a chance to learn about Salesforce, a big CRM tool and currently, working as an Salesforce Admin and Developer. 
            </p>
            ...
            <p className=" text-dark font-medium dark:text-light">
              ...
              clients visions to life in the digital realm. Whether I&#39;m deep in
              the code of a new website, Salesforce platform, or
            ...
            <p className=" text-dark font-medium dark:text-light mt-5 mb-5 ">
              ...
              latest best practices into my work. I&#39;m always on the lookout
            ...
            <p className=" text-dark font-medium dark:text-light">
              {" "}
              If you&#39;re seeking someone who brings a blend of technical
